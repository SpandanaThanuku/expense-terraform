...
module "backend" {
  ...
  parameters          = ["arn:aws:ssm:us-east-1:348220191398:parameter/${var.env}.${var.project_name}.rds.*","arn:aws:ssm:us-east-1:348220191398:parameter/newrelic.*"]
  kms                 = var.kms_key_id
...
module "frontend" {
  ...
  parameters          = ["arn:aws:ssm:us-east-1:348220191398:parameter/newrelic.*"]
  kms                 = var.kms_key_id
  prometheus_cidrs    = var.prometheus_cidrs
}
