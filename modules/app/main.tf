resource "aws_security_group" "main" {
  ...
  ingress {
    ...
    to_port          = 22
    protocol         = "tcp"
    cidr_blocks      = var.bastion_cidrs # here bastion is workstation node #
    description      = "SSH"
  }
...
resource "aws_launch_template" "main" {
  ...
  user_data              = base64encode(template_file("${path.module}/userdata.sh", {
      ...
      "Statement" : [
        {
          ...
          "Resource" :"arn:aws:ssm:us-east-1:348220191398:parameter/dev.expense.frontend.*"
        },
        {
